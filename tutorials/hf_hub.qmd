...
멋집니다! 이제 여러분은 자신의 프로젝트를 실행할 스페이스를 생성했고 다른 참가자들에게 빨리 소개하고 싶습니다. 프로젝트를 해커톤 컬렉션에 연결하는 방법을 알아 봅시다.
...
`Hugging Face KREW Hackathon 2023 (pseudolab)`을 선택하여 자신의 프로젝트를 해커톤 컬렉션에 추가할 수 있습니다.
...
After signing up, proceed to the [Contributor Registration](https://huggingface.co/organizations/pseudolab/share/UYPZnwyOTadGJDReehItrwtbWKSxHYmAku) page and gain the privilege to contribute to 'Pseudo Lab' projects. This platform is where your ideas will shine.
...
### Sharing in the Collection

Fantastic! Now that you've created a space for launching your project, you're probably eager to introduce it to other participants. Let’s see how to link your project to the hackathon collection.

![](images/paste-7.png){fig-align="center"}

Click the `...` button in the upper right corner and select `Add to collection`.

![](images/paste-8.png){fig-align="center"}

Choose `Hugging Face KREW Hackathon 2023 (pseudolab)` to add your project to the hackathon collection.
