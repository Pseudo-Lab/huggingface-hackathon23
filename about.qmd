...
참가자들은 동작하는 데모를 등록하는 것으로 수료증을 받을 수 있으며 기술의 난이도를 측정하지 않습니다.

일상에서의 AI해커톤을 통해서 허깅페이스에 관심이 있는 사람을 만나고 경쟁이 아닌 협업을 통해서 함께 발전하길 바라는 대회입니다.
...
허깅페이스에 처음이거나 익숙하지 않더라도 함께 공부한 참가자들과 이야기할 디스코드 채널을 통해서 함께 발전합니다.
