...
2.  각 팀은 기능을 구현하고 [[허깅페이스 스페이스](https://huggingface.co/huggingface-hackathon-korea)]에 프로젝트를 배포합니다.
3.  프로젝트에 대한 소개를 허깅페이스 space `readme.md`에 작성하고 [[제출하기](./submit.qmd)]를 눌러 프로젝트를 제출하세요.



허깅페이스에 처음이거나 익숙하지 않더라도 함께 공부한 참가들과 이야기할 Discord채널을 통해서 함께 발전합니다. 대회 기간동안 허깅페이스를 배울 수 있는 다양한 자료를 튜토리얼에 공유할 예정이니 배우면서 진행해도 좋습니다.

아래 디스코드 버튼을 눌러 허깅페이스와 AI에 대한 열정을 공유하는 동료들을 만나보세요.
...
:::{#second-column}
[**디스코드 입장**](./about.qmd){.center .btn-primary .btn .btn-lg role="button"}
:::
...
디스코드에는 운영진도 함께하고 있습니다. 대회에 대한 자세한 내용은 [운영안내](./logistics/index.qmd)에서 확인할 수 있으며 궁금하신점은 언제라도 디스코드에서 문의해주세요.
